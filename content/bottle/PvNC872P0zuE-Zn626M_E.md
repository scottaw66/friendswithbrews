...
path = "bottle/PvNC872P0zuE-Zn626M_E"
template = "bottle.html"

[extra]
brewery = "Tony's Coffee"
image = "TonysCoffeeMexicoChiapas20251027"
...
host = "Scott"
vote = "thumbs-up"
description = "I'm not the HUGEST fan of Tony's Coffee (sorry, Tony) but this is a good coffee prepared with the pourover method and I give it a thumbs-up. Just STOP with the federation talk if you can't also include a description of the coffee itself!!"
+++
